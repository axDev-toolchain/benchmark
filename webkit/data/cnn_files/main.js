...
function cnnRenderGenericBanner(object,flashURL,leftColor,rightColor)
{
	...
	if ((object.type == 'Live Breaking News' || object.type == 'Live Developing Story' || object.type == 'Live Election Coverage' || object.type == 'Live Inauguration Coverage') && object.image.length > 0)
	{
