...
static const HashTableValue JSHTMLFrameSetElementTableValues[13] =
{
    ...
    { "onorientationchange", DontDelete|DontEnum, (intptr_t)jsHTMLFrameSetElementOnorientationchange, (intptr_t)setJSHTMLFrameSetElementOnorientationchange },
...
JSValue jsHTMLFrameSetElementOnorientationchange(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSHTMLFrameSetElement* castedThis = static_cast<JSHTMLFrameSetElement*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
    HTMLFrameSetElement* imp = static_cast<HTMLFrameSetElement*>(castedThis->impl());
