...
JSC::JSValue jsDOMWindowOrientation(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
...
JSC::JSValue jsDOMWindowOnorientationchange(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
